...
@JsonDeserialize(builder = PostThreadsResponseDataPollOptionsItem.Builder.class)
public final class PostThreadsResponseDataPollOptionsItem {
    ...
    private PostThreadsResponseDataPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostThreadsResponseDataPollOptionsItem
                && equalTo((PostThreadsResponseDataPollOptionsItem) other);
    }
    ...
    private boolean equalTo(PostThreadsResponseDataPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(PostThreadsResponseDataPollOptionsItem other);
    }

    public interface _FinalStage {
        PostThreadsResponseDataPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PostThreadsResponseDataPollOptionsItem other) {
        ...
        @java.lang.Override
        public PostThreadsResponseDataPollOptionsItem build() {
            return new PostThreadsResponseDataPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
