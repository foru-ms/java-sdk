...
@JsonDeserialize(builder = UpdateThreadsResponseDataPollOptionsItem.Builder.class)
public final class UpdateThreadsResponseDataPollOptionsItem {
    ...
    private UpdateThreadsResponseDataPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateThreadsResponseDataPollOptionsItem
                && equalTo((UpdateThreadsResponseDataPollOptionsItem) other);
    }
    ...
    private boolean equalTo(UpdateThreadsResponseDataPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(UpdateThreadsResponseDataPollOptionsItem other);
    }

    public interface _FinalStage {
        UpdateThreadsResponseDataPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateThreadsResponseDataPollOptionsItem other) {
        ...
        @java.lang.Override
        public UpdateThreadsResponseDataPollOptionsItem build() {
            return new UpdateThreadsResponseDataPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
