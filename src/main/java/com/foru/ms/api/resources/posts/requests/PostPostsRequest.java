...
@JsonDeserialize(builder = PostPostsRequest.Builder.class)
public final class PostPostsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostPostsRequest && equalTo((PostPostsRequest) other);
    }
    ...
    private boolean equalTo(PostPostsRequest other) {
    ...
    public interface ThreadIdStage {
        ...
        Builder from(PostPostsRequest other);
    }
    ...
    public static final class Builder implements ThreadIdStage, BodyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PostPostsRequest other) {
        ...
        @java.lang.Override
        public PostPostsRequest build() {
            return new PostPostsRequest(threadId, body, userId, parentId, extendedData, additionalProperties);
        }
    }
}
