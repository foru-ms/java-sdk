...
@JsonDeserialize(builder = GetThreadsResponseDataItemPollOptionsItem.Builder.class)
public final class GetThreadsResponseDataItemPollOptionsItem {
    ...
    private GetThreadsResponseDataItemPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetThreadsResponseDataItemPollOptionsItem
                && equalTo((GetThreadsResponseDataItemPollOptionsItem) other);
    }
    ...
    private boolean equalTo(GetThreadsResponseDataItemPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(GetThreadsResponseDataItemPollOptionsItem other);
    }

    public interface _FinalStage {
        GetThreadsResponseDataItemPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetThreadsResponseDataItemPollOptionsItem other) {
        ...
        @java.lang.Override
        public GetThreadsResponseDataItemPollOptionsItem build() {
            return new GetThreadsResponseDataItemPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
