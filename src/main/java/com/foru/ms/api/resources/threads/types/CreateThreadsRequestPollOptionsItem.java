...
@JsonDeserialize(builder = CreateThreadsRequestPollOptionsItem.Builder.class)
public final class CreateThreadsRequestPollOptionsItem {
    ...
    private CreateThreadsRequestPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateThreadsRequestPollOptionsItem
                && equalTo((CreateThreadsRequestPollOptionsItem) other);
    }
    ...
    private boolean equalTo(CreateThreadsRequestPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(CreateThreadsRequestPollOptionsItem other);
    }

    public interface _FinalStage {
        CreateThreadsRequestPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateThreadsRequestPollOptionsItem other) {
        ...
        @java.lang.Override
        public CreateThreadsRequestPollOptionsItem build() {
            return new CreateThreadsRequestPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
