...
@JsonDeserialize(builder = CreateRolesRequest.Builder.class)
public final class CreateRolesRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateRolesRequest && equalTo((CreateRolesRequest) other);
    }
    ...
    private boolean equalTo(CreateRolesRequest other) {
    ...
    public interface NameStage {
        ...
        Builder from(CreateRolesRequest other);
    }

    public interface _FinalStage {
        CreateRolesRequest build();
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateRolesRequest other) {
            name(other.getName());
            slug(other.getSlug());
        ...
        @java.lang.Override
        public CreateRolesRequest build() {
            return new CreateRolesRequest(name, slug, description, color, extendedData, additionalProperties);
        }
    }
}
