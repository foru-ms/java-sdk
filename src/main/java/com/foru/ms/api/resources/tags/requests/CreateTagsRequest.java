...
@JsonDeserialize(builder = CreateTagsRequest.Builder.class)
public final class CreateTagsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateTagsRequest && equalTo((CreateTagsRequest) other);
    }
    ...
    private boolean equalTo(CreateTagsRequest other) {
    ...
    public interface NameStage {
        ...
        Builder from(CreateTagsRequest other);
    }

    public interface _FinalStage {
        CreateTagsRequest build();
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateTagsRequest other) {
            name(other.getName());
            slug(other.getSlug());
        ...
        public CreateTagsRequest build() {
            return new CreateTagsRequest(name, slug, description, color, extendedData, additionalProperties);
        }
    }
}
