...
@JsonDeserialize(builder = CreatePollThreadsRequestOptionsItem.Builder.class)
public final class CreatePollThreadsRequestOptionsItem {
    ...
    private CreatePollThreadsRequestOptionsItem(
            String title,
    ...
    /**
     * @return Optional color for display
     */
    @JsonProperty("color")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreatePollThreadsRequestOptionsItem
                && equalTo((CreatePollThreadsRequestOptionsItem) other);
    }
    ...
    private boolean equalTo(CreatePollThreadsRequestOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(CreatePollThreadsRequestOptionsItem other);
    }

    public interface _FinalStage {
        CreatePollThreadsRequestOptionsItem build();

        /**
         * <p>Optional color for display</p>
         */
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreatePollThreadsRequestOptionsItem other) {
        ...
        @java.lang.Override
        public CreatePollThreadsRequestOptionsItem build() {
            return new CreatePollThreadsRequestOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
