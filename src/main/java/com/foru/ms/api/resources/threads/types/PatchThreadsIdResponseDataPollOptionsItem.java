...
@JsonDeserialize(builder = PatchThreadsIdResponseDataPollOptionsItem.Builder.class)
public final class PatchThreadsIdResponseDataPollOptionsItem {
    ...
    private PatchThreadsIdResponseDataPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PatchThreadsIdResponseDataPollOptionsItem
                && equalTo((PatchThreadsIdResponseDataPollOptionsItem) other);
    }
    ...
    private boolean equalTo(PatchThreadsIdResponseDataPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(PatchThreadsIdResponseDataPollOptionsItem other);
    }

    public interface _FinalStage {
        PatchThreadsIdResponseDataPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PatchThreadsIdResponseDataPollOptionsItem other) {
        ...
        @java.lang.Override
        public PatchThreadsIdResponseDataPollOptionsItem build() {
            return new PatchThreadsIdResponseDataPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
