...
@JsonDeserialize(builder = PostThreadsRequestPollOptionsItem.Builder.class)
public final class PostThreadsRequestPollOptionsItem {
    ...
    private PostThreadsRequestPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostThreadsRequestPollOptionsItem && equalTo((PostThreadsRequestPollOptionsItem) other);
    }
    ...
    private boolean equalTo(PostThreadsRequestPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(PostThreadsRequestPollOptionsItem other);
    }

    public interface _FinalStage {
        PostThreadsRequestPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PostThreadsRequestPollOptionsItem other) {
        ...
        @java.lang.Override
        public PostThreadsRequestPollOptionsItem build() {
            return new PostThreadsRequestPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
