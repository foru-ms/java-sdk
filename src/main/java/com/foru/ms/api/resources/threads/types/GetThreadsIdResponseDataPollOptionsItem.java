...
@JsonDeserialize(builder = GetThreadsIdResponseDataPollOptionsItem.Builder.class)
public final class GetThreadsIdResponseDataPollOptionsItem {
    ...
    private GetThreadsIdResponseDataPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetThreadsIdResponseDataPollOptionsItem
                && equalTo((GetThreadsIdResponseDataPollOptionsItem) other);
    }
    ...
    private boolean equalTo(GetThreadsIdResponseDataPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(GetThreadsIdResponseDataPollOptionsItem other);
    }

    public interface _FinalStage {
        GetThreadsIdResponseDataPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetThreadsIdResponseDataPollOptionsItem other) {
        ...
        @java.lang.Override
        public GetThreadsIdResponseDataPollOptionsItem build() {
            return new GetThreadsIdResponseDataPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
