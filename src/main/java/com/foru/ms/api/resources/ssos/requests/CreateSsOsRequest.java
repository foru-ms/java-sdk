...
import com.foru.ms.api.resources.ssos.types.CreateSsOsRequestProvider;
...
@JsonDeserialize(builder = CreateSsOsRequest.Builder.class)
public final class CreateSsOsRequest {
    private final CreateSsOsRequestProvider provider;
    ...
    private CreateSsOsRequest(
            CreateSsOsRequestProvider provider,
            String domain,
    ...
    public CreateSsOsRequestProvider getProvider() {
        return provider;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateSsOsRequest && equalTo((CreateSsOsRequest) other);
    }
    ...
    private boolean equalTo(CreateSsOsRequest other) {
    ...
    public interface ProviderStage {
         ...
         */
        DomainStage provider(@NotNull CreateSsOsRequestProvider provider);

        Builder from(CreateSsOsRequest other);
    }
    ...
    public static final class Builder implements ProviderStage, DomainStage, _FinalStage {
        private CreateSsOsRequestProvider provider;
        ...
        @java.lang.Override
        public Builder from(CreateSsOsRequest other) {
        ...
        @java.lang.Override
        @JsonSetter("provider")
        public DomainStage provider(@NotNull CreateSsOsRequestProvider provider) {
        ...
        @java.lang.Override
        public CreateSsOsRequest build() {
            return new CreateSsOsRequest(provider, domain, config, active, extendedData, additionalProperties);
        }
    }
}
