...
public class AsyncForumClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncForumClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncForumClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncForumClientBuilder url(String url) {
     ...
     */
    public AsyncForumClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncForumClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncForumClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncForumClientBuilder addHeader(String name, String value) {
    ...
    public AsyncForumClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncForumClient(buildClientOptions());
    }
}
