...
@JsonDeserialize(builder = ThreadCreatePollOptionsItem.Builder.class)
public final class ThreadCreatePollOptionsItem {
    ...
    private ThreadCreatePollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThreadCreatePollOptionsItem && equalTo((ThreadCreatePollOptionsItem) other);
    }
    ...
    private boolean equalTo(ThreadCreatePollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(ThreadCreatePollOptionsItem other);
    }

    public interface _FinalStage {
        ThreadCreatePollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ThreadCreatePollOptionsItem other) {
        ...
        @java.lang.Override
        public ThreadCreatePollOptionsItem build() {
            return new ThreadCreatePollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
