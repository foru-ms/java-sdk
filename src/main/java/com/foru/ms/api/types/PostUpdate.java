...
@JsonDeserialize(builder = PostUpdate.Builder.class)
public final class PostUpdate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostUpdate && equalTo((PostUpdate) other);
    }
    ...
    private boolean equalTo(PostUpdate other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PostUpdate other) {
            body(other.getBody());
        ...
        public PostUpdate build() {
            return new PostUpdate(body, threadId, parentId, extendedData, additionalProperties);
        }
    }
}
