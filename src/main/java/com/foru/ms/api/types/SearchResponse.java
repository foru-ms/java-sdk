...
public final class SearchResponse {
    ...
    private SearchResponse(SearchResponseData data, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public interface DataStage {
        _FinalStage data(@NotNull SearchResponseData data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull SearchResponseData data) {
        ...
        public SearchResponse build() {
            return new SearchResponse(data, additionalProperties);
        }
    }
}
