...
@JsonDeserialize(builder = PostCreate.Builder.class)
public final class PostCreate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PostCreate && equalTo((PostCreate) other);
    }
    ...
    private boolean equalTo(PostCreate other) {
    ...
    public static final class Builder implements ThreadIdStage, BodyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PostCreate other) {
        ...
        public PostCreate build() {
            return new PostCreate(threadId, body, userId, parentId, extendedData, additionalProperties);
        }
    }
}
