...
@JsonDeserialize(builder = ThreadUpdate.Builder.class)
public final class ThreadUpdate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThreadUpdate && equalTo((ThreadUpdate) other);
    }
    ...
    private boolean equalTo(ThreadUpdate other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ThreadUpdate other) {
        ...
        public ThreadUpdate build() {
            return new ThreadUpdate(title, body, locked, pinned, tags, extendedData, additionalProperties);
        }
    }
}
