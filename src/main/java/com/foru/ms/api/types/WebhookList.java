...
public final class WebhookList {
    ...
    private WebhookList(Optional<Double> limit, Optional<String> cursor, Map<String, Object> additionalProperties) {
        this.limit = limit;
        this.cursor = cursor;
    ...
    public static final class Builder {
        ...
        public WebhookList build() {
            return new WebhookList(limit, cursor, additionalProperties);
        }
    }
}
