...
@JsonDeserialize(builder = ThreadListResponseDataItemsItemPollOptionsItem.Builder.class)
public final class ThreadListResponseDataItemsItemPollOptionsItem {
    ...
    private ThreadListResponseDataItemsItemPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThreadListResponseDataItemsItemPollOptionsItem
                && equalTo((ThreadListResponseDataItemsItemPollOptionsItem) other);
    }
    ...
    private boolean equalTo(ThreadListResponseDataItemsItemPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(ThreadListResponseDataItemsItemPollOptionsItem other);
    }

    public interface _FinalStage {
        ThreadListResponseDataItemsItemPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ThreadListResponseDataItemsItemPollOptionsItem other) {
        ...
        @java.lang.Override
        public ThreadListResponseDataItemsItemPollOptionsItem build() {
            return new ThreadListResponseDataItemsItemPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
