...
@JsonDeserialize(builder = RoleCreate.Builder.class)
public final class RoleCreate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RoleCreate && equalTo((RoleCreate) other);
    }
    ...
    private boolean equalTo(RoleCreate other) {
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(RoleCreate other) {
            name(other.getName());
            slug(other.getSlug());
        ...
        @java.lang.Override
        public RoleCreate build() {
            return new RoleCreate(name, slug, description, color, extendedData, additionalProperties);
        }
    }
}
