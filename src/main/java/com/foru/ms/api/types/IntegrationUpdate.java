...
@JsonDeserialize(builder = IntegrationUpdate.Builder.class)
public final class IntegrationUpdate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IntegrationUpdate && equalTo((IntegrationUpdate) other);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(IntegrationUpdate other) {
            name(other.getName());
