...
@JsonDeserialize(builder = TagCreate.Builder.class)
public final class TagCreate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TagCreate && equalTo((TagCreate) other);
    }
    ...
    private boolean equalTo(TagCreate other) {
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(TagCreate other) {
            name(other.getName());
            slug(other.getSlug());
        ...
        public TagCreate build() {
            return new TagCreate(name, slug, description, color, extendedData, additionalProperties);
        }
    }
}
