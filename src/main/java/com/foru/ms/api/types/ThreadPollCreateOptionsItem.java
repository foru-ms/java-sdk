...
@JsonDeserialize(builder = ThreadPollCreateOptionsItem.Builder.class)
public final class ThreadPollCreateOptionsItem {
    ...
    private ThreadPollCreateOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThreadPollCreateOptionsItem && equalTo((ThreadPollCreateOptionsItem) other);
    }
    ...
    private boolean equalTo(ThreadPollCreateOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(ThreadPollCreateOptionsItem other);
    }

    public interface _FinalStage {
        ThreadPollCreateOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ThreadPollCreateOptionsItem other) {
        ...
        @java.lang.Override
        public ThreadPollCreateOptionsItem build() {
            return new ThreadPollCreateOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
