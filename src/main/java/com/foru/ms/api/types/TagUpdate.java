...
@JsonDeserialize(builder = TagUpdate.Builder.class)
public final class TagUpdate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TagUpdate && equalTo((TagUpdate) other);
    }
    ...
    private boolean equalTo(TagUpdate other) {
    ...
    public static final class Builder {
        ...
        public Builder from(TagUpdate other) {
            name(other.getName());
            slug(other.getSlug());
        ...
        public TagUpdate build() {
            return new TagUpdate(name, slug, description, color, extendedData, additionalProperties);
        }
    }
}
