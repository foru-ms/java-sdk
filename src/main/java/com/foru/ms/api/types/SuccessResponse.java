...
public final class SuccessResponse {
    private final SuccessResponseData data;

    private final Map<String, Object> additionalProperties;

    private SuccessResponse(SuccessResponseData data, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public interface DataStage {
        _FinalStage data(@NotNull SuccessResponseData data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull SuccessResponseData data) {
        ...
        public SuccessResponse build() {
            return new SuccessResponse(data, additionalProperties);
        }
    }
}
