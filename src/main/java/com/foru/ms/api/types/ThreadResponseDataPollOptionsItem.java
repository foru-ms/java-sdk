...
@JsonDeserialize(builder = ThreadResponseDataPollOptionsItem.Builder.class)
public final class ThreadResponseDataPollOptionsItem {
    ...
    private ThreadResponseDataPollOptionsItem(
            String title,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ThreadResponseDataPollOptionsItem && equalTo((ThreadResponseDataPollOptionsItem) other);
    }
    ...
    private boolean equalTo(ThreadResponseDataPollOptionsItem other) {
    ...
    public interface TitleStage {
        ...
        Builder from(ThreadResponseDataPollOptionsItem other);
    }

    public interface _FinalStage {
        ThreadResponseDataPollOptionsItem build();
    ...
    public static final class Builder implements TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ThreadResponseDataPollOptionsItem other) {
        ...
        @java.lang.Override
        public ThreadResponseDataPollOptionsItem build() {
            return new ThreadResponseDataPollOptionsItem(title, color, extendedData, additionalProperties);
        }
    }
}
