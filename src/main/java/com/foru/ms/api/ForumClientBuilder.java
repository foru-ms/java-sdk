...
public class ForumClientBuilder {
     ...
     * Sets apiKey
     */
    public ForumClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public ForumClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public ForumClientBuilder url(String url) {
     ...
     */
    public ForumClientBuilder timeout(int timeout) {
     ...
     */
    public ForumClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public ForumClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public ForumClientBuilder addHeader(String name, String value) {
    ...
    public ForumClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new ForumClient(buildClientOptions());
    }
}
